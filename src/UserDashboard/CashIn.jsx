...
export default function CashIn() {
  ...
  const handleCashIn = (event) => {
    ...
    // Implement logic to send cash-in request to backend
    console.log(`Cash-in request: Amount - ${amount}, Agent Phone Number - ${agentPhoneNumber}`);
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div className="text-center">
              <h1 className="text-3xl font-semibold mb-4">Cash-in</h1>
            </div>
